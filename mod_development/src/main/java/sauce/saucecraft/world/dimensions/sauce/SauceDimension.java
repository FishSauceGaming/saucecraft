...
public class SauceDimension extends Dimension
{
	public SauceDimension(World worldIn, DimensionType typeIn) 
	{
   ...
   {
	   BiomeProviderType<SauceBiomeProviderSettings, SauceBiomeProvider> biomeprovidertype1 = new BiomeProviderType<>(SauceBiomeProvider::new,SauceBiomeProviderSettings::new);
	   SauceBiomeProviderSettings biomeprovidersettings1 = biomeprovidertype1.createSettings().setGeneratorSettings(new SauceGenSettings()).setWorldInfo(this.world.getWorldInfo());
	   SauceBiomeProvider biomeprovider = biomeprovidertype1.create(biomeprovidersettings1);

	   ChunkGeneratorType<SauceGenSettings, SauceChunkGenerator> chunkgeneratortype4 = new ChunkGeneratorType<>(SauceChunkGenerator::new, true, SauceGenSettings::new);
	   SauceGenSettings gensettings1 = chunkgeneratortype4.createSettings();
