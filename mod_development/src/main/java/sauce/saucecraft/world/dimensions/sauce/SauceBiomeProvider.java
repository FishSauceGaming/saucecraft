...
public class SauceBiomeProvider extends BiomeProvider
{
   ...
   public SauceBiomeProvider(SauceBiomeProviderSettings settingsProvider) {
      ...
      SauceGenSettings overworldgensettings = settingsProvider.getGeneratorSettings();
      Layer[] alayer = SauceLayerUtil.buildOverworldProcedure(worldinfo.getSeed(), new SauceWorldType(), overworldgensettings);
