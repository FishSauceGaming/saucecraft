package sauce.saucecraft.world.gen.structures.igloo;
...
public class IglooStructure extends ScatteredStructure<NoFeatureConfig> {
   ...
   public static class Start extends StructureStart {
      ...
      public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
         NoFeatureConfig nofeatureconfig = (NoFeatureConfig)generator.getStructureConfig(biomeIn, ModFeatures.IGLOO);
         int i = chunkX * 16;
         int j = chunkZ * 16;
