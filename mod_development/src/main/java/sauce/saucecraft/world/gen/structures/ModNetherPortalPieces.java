...
public class ModNetherPortalPieces {
    private static final ResourceLocation modnetherportal = new ResourceLocation(Reference.MODID, "modnetherportal");


    private static final Map<ResourceLocation, BlockPos> structurePos = ImmutableMap.of(modnetherportal, BlockPos.ZERO);
    ...
    public static void addStructure(TemplateManager p_207617_0_, BlockPos blockpos, Rotation p_207617_2_, List<StructurePiece> p_207617_3_, Random p_207617_4_) {
        p_207617_3_.add(new ModNetherPortalPieces.Piece(p_207617_0_, modnetherportal, blockpos, p_207617_2_, 0));
    }
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public Piece(TemplateManager p_i49313_1_, ResourceLocation p_i49313_2_, BlockPos p_i49313_3_, Rotation p_i49313_4_, int p_i49313_5_) {
            super(ModFeatures.NETHERPORTAL_STRUCTURE, 0);
            this.field_207615_d = p_i49313_2_;
            BlockPos blockpos = ModNetherPortalPieces.structurePos.get(p_i49313_2_);
        ...
        public Piece(TemplateManager p_i50566_1_, CompoundNBT p_i50566_2_) {
            super(ModFeatures.NETHERPORTAL_STRUCTURE, p_i50566_2_);
        ...
        private void func_207614_a(TemplateManager p_207614_1_) {
            ...
            PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.field_207616_e).setMirror(Mirror.NONE).setCenterOffset(ModNetherPortalPieces.structurePos.get(this.field_207615_d)).addProcessor(BlockIgnoreStructureProcessor.STRUCTURE_BLOCK);
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
            PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.field_207616_e).setMirror(Mirror.NONE).setCenterOffset(ModNetherPortalPieces.structurePos.get(this.field_207615_d)).addProcessor(BlockIgnoreStructureProcessor.STRUCTURE_BLOCK);
            BlockPos blockpos = ModNetherPortalPieces.structurePos.get(this.field_207615_d);
            ...
            this.templatePosition = this.templatePosition.add(0, i - 89, 0);
