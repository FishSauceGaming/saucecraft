...
public class WaterSheepPieces {
    private static final ResourceLocation watersheep = new ResourceLocation(Reference.MODID, "watersheep");


    private static final Map<ResourceLocation, BlockPos> structurePos = ImmutableMap.of(watersheep, BlockPos.ZERO);
    ...
    public static void addStructure(TemplateManager p_207617_0_, BlockPos blockpos, Rotation p_207617_2_, List<StructurePiece> p_207617_3_, Random p_207617_4_) {
        p_207617_3_.add(new WaterSheepPieces.Piece(p_207617_0_, watersheep, blockpos, p_207617_2_, 0));
    }
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public Piece(TemplateManager p_i49313_1_, ResourceLocation p_i49313_2_, BlockPos p_i49313_3_, Rotation p_i49313_4_, int p_i49313_5_) {
            super(ModFeatures.WATERSHEEP_STRUCTURE, 0);
            this.field_207615_d = p_i49313_2_;
            BlockPos blockpos = WaterSheepPieces.structurePos.get(p_i49313_2_);
        ...
        public Piece(TemplateManager p_i50566_1_, CompoundNBT p_i50566_2_) {
            super(ModFeatures.WATERSHEEP_STRUCTURE, p_i50566_2_);
        ...
        private void func_207614_a(TemplateManager p_207614_1_) {
            ...
            PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.field_207616_e).setMirror(Mirror.NONE).setCenterOffset(WaterSheepPieces.structurePos.get(this.field_207615_d)).addProcessor(BlockIgnoreStructureProcessor.STRUCTURE_BLOCK);
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
            PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.field_207616_e).setMirror(Mirror.NONE).setCenterOffset(WaterSheepPieces.structurePos.get(this.field_207615_d)).addProcessor(BlockIgnoreStructureProcessor.STRUCTURE_BLOCK);
            BlockPos blockpos = WaterSheepPieces.structurePos.get(this.field_207615_d);
