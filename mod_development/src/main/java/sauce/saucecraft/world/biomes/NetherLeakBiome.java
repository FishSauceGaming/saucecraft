...
public class NetherLeakBiome extends Biome{
	
	

	
	 @SuppressWarnings("static-access")
	public NetherLeakBiome(){
		 
		  super((new Biome.Builder()).surfaceBuilder(new ConfiguredSurfaceBuilder<SurfaceBuilderConfig>(SurfaceBuilder.NETHER, SurfaceBuilder.NETHERRACK_CONFIG)).precipitation(Biome.RainType.NONE).category(Biome.Category.NETHER).depth(0.7F).scale(0.5F).temperature(0.7F).downfall(0.8F).waterColor(4159204).waterFogColor(329011).parent((String)null));
	      ...
	      this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, Biome.createDecoratedFeature(ModFeatures.NETHERPORTAL, IFeatureConfig.NO_FEATURE_CONFIG, Placement.NOPE, IPlacementConfig.NO_PLACEMENT_CONFIG));
          this.addStructure(ModFeatures.NETHERPORTAL, IFeatureConfig.NO_FEATURE_CONFIG);
