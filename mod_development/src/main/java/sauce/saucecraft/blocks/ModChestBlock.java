...
public class ModChestBlock extends ContainerBlock implements IWaterLoggable {
   ...
   private static final ModChestBlock.InventoryFactory<IInventory> field_220109_i = new ModChestBlock.InventoryFactory<IInventory>() {
   ...
   public static final ModChestBlock.InventoryFactory<INamedContainerProvider> field_220110_j = new ModChestBlock.InventoryFactory<INamedContainerProvider>() {
   ...
   public ModChestBlock(Block.Properties properties) {
      super(properties);
...
public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
   ...
   @Nullable
   public static <T> T func_220106_a(BlockState p_220106_0_, IWorld p_220106_1_, BlockPos p_220106_2_, boolean allowBlocked, ModChestBlock.InventoryFactory<T> p_220106_4_) {
