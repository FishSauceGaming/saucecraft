...
public class PurplestoneWireBlock extends Block{
   ...
   private static float ColR1;
   private static float ColG1;
   private static float ColB1;
   private static float ColR2;
   private static float ColG2;
   private static float ColB2;
   ...
   public PurplestoneWireBlock(Block.Properties properties, int r,int g,int b,int r2,int g2,int b2) {
      super(properties);
      ColR2=r2/255.0F;
      ColG2=g2/255.0F;
      ColB2=b2/255.0F;
      ColR1=r/255.0F-ColR2;
      ColG1=g/255.0F-ColG2;
      ColB1=b/255.0F-ColB2;
   ...
   public BlockState updateSurroundingRedstone(World worldIn, BlockPos pos, BlockState state) {
   ...
   protected static boolean canConnectTo(BlockState blockState, IBlockReader world, BlockPos pos, @Nullable Direction side) {
      ...
      if (block == ModBlocks.purplestone_wire) {
    	  return true;
      }
      ...
      else if (block == ModBlocks.COLOREDSTONE_REPEATER) {
    	  Direction direction = blockState.get(ColoredstoneRepeaterBlock.HORIZONTAL_FACING);
          return direction == side || direction.getOpposite() == side;
      }
      else if (block == ModBlocks.COLOREDSTONE_COMPARATOR) {
    	  Direction direction = blockState.get(ColoredstoneComparatorBlock.HORIZONTAL_FACING);
          return direction == side || direction.getOpposite() == side;
      }
      else {
         return false;
   ...
   public static int colorMultiplier(int p_176337_0_) {
       ...
       float f1 = f * ColR1 + ColR2;
       float f2 = f * ColG1 + ColG2;
       float f3 = f * ColB1 + ColB2;
