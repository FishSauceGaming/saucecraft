...
public class BrownstoneWireBlock extends Block{
   ...
   public BrownstoneWireBlock(Block.Properties properties, int r,int g,int b,int r2,int g2,int b2) {
      super(properties);
      ColR2=r2/255.0F;
      ColG2=g2/255.0F;
      ColB2=b2/255.0F;
   ...
   protected static boolean canConnectTo(BlockState blockState, IBlockReader world, BlockPos pos, @Nullable Direction side) {
      ...
      if (block == ModBlocks.brownstone_wire) {
    	  return true;
      }
